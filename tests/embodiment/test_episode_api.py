...
async def _executor(spec, credential, cancel_event, publish_frame):
...
def test_episode_frame_is_loading_without_player_pixels() -> None:
    async def waiting_executor(spec, credential, cancel_event, publish_frame):
        del spec, credential, publish_frame
