class_name EmbodimentManagedSessionHostV2
extends RefCounted
...
func begin_handshake() -> Dictionary:
	...
	return _codec.encode("hello", CodecV2.ZERO_HASH, {"connection_id": _connection_id})
...
func checkpoint_hash() -> String:
	return _dispatcher.checkpoint_hash() if _dispatcher != null else CodecV2.ZERO_HASH
...
func _valid_result_shape(result: Dictionary) -> bool:
	...
	return _exact_body(result, ["observations", "receipts", "public_events", "state_hash", "terminal"]) \
